      ...
      <div className={this.props.classes.section} >
        ...
        { this.state.open ?
          <div>
            ...
            >
              <a href="#services">
                <Button raised dense className={this.props.classes.services} onClick={this.handleRequest}>
                  what we do
                </Button>
              </a>
            </Fade>
            ...
            >
              <a href="#how">
                <Button raised dense className={this.props.classes.how} onClick={this.handleRequest}>
                  how
                </Button>
              </a>
            </Fade>
            ...
            >
              <a href="#pricing">
                <Button raised dense className={this.props.classes.pricing} onClick={this.handleRequest}>
                  pricing
                </Button>
              </a>
            </Fade>
            ...
            >
              <a href="#quote">
                <Button raised dense className={this.props.classes.quote} onClick={this.handleRequest}>
                  quote
                </Button>
              </a>
            </Fade>
            ...
            >
              <a href="#faq">
                <Button raised dense className={this.props.classes.faq} onClick={this.handleRequest}>
                  faq
                </Button>
              </a>
            </Fade>
            ...
            >
              <a href="#contact">
                <Button raised dense className={this.props.classes.contact} onClick={this.handleRequest}>
                  contact
                </Button>
              </a>
            </Fade>
