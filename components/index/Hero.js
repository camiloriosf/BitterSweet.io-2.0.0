      ...
      <Grid item xs={12} sm={12} className={this.props.classes.pad4}>
        <Hidden smDown>
          <div className={this.props.classes.crop1}>
            <Slide direction="up" enterTransitionDuration={500} in><img src={`${env.imageURI}home_mockups_1.png`} alt="WebSite Mockup 1" className={this.props.classes.mockup1} /></Slide>
