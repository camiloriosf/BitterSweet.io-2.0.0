    ...
    return (
      <div className={this.props.classes.slide}>
        ...
        <Dialog open={this.state.open} onRequestClose={this.handleRequestClose}>
          <DialogTitle>
            {this.props.t('quote.sections.Product.dialog.title')}
          </DialogTitle>
          <DialogContent>
            <DialogContentText>
              {this.props.t('quote.sections.Product.dialog.content.0')}<br /><br />
              {this.props.t('quote.sections.Product.dialog.content.1')}<br /><br />
              {this.props.t('quote.sections.Product.dialog.content.2')}<br /><br />
              {this.props.t('quote.sections.Product.dialog.content.3')}
            </DialogContentText>
          </DialogContent>
          <DialogActions>
            <Button onClick={this.handleRequestClose} color="primary">
              {this.props.t('quote.sections.Product.dialog.button')}
            </Button>
          </DialogActions>
        </Dialog>
      </div>
